...
$(document).ready(function () {
    ...
    setInterval(function () {
        ...
        $.getJSON('?ajax=true', function (data) {
            ...
            $("#loveDuration").text(loveDuration());
...
function uptimeFormat(str) {
    ...
    if (min === 0 || min === 1) {
        uptime = uptime + min + " minute";
    } else {
        uptime = uptime + min + " minutes";
    }
...
function loveDuration() {
    ...
    if (day !== 0) {
        if (day === 1) {
            loveDuration = day + " day ";
        } else {
            loveDuration = day + " days ";
        }
    }

    if (hour !== 0) {
        if (hour == 1) {
            loveDuration = loveDuration + hour + " hour ";
        } else {
            loveDuration = loveDuration + hour + " hours ";
        }
    }

    if (minute === 0 || minute === 1) {
        loveDuration = loveDuration + minute + " minute ";
    } else {
        loveDuration = loveDuration + minute + " minutes ";
    }

    if (second === 0 || second === 1) {
        loveDuration = loveDuration + second + " second";
    } else {
        loveDuration = loveDuration + second + " seconds";
    }
